...
//     *   Bits 32-62:  sparse: sparseLength, dense: array index of node
...
//    }
//
//    protected long toSparseRaw(final long rawPosition, final int length) {
//        return (rawPosition & 0x80000000) & (length & 0x7FFFFFFF);
//    }
//
//    protected long toSparseRaw(final int position, final int length) {
//        return toSparseRaw(toPositionRaw(position), length);
//    }
//
...
//    }
//
//    private long toDenseRangeRaw(final int position, final int dataPositionOffset) {
//        return ((long)(0x80000000 + dataPositionOffset & 0x7FFFFFFF)) + position << 32;
//    }
//
//    /**
//     *
...
//            final @Nonnull HMNode targetNode,
//            final @Nonnull SBS2 o,
//            final @Nonnegative int startPosition,
//            final @Nonnegative int endPosition) {
//
...
//
//        if (startPosition % 64 != 0) throw new IllegalArgumentException();
//        if (endPosition % 64 != 0) throw new IllegalArgumentException();
//
//        final int nodeStartPosition = targetNode.getStartPosition();
//        final int offsetInBitPosition = startPosition - nodeStartPosition;
//        if (offsetInBitPosition < 0) throw new IllegalStateException();
//
//        final long[] nodeData = targetNode.getData();
//
//        final int i = offsetInBitPosition / 64;
//        final int z = (endPosition - startPosition + offsetInBitPosition) / 64 + 1;
//
//        rawLongApply(nodeData, o, i, z, startPosition + i * 64, startPosition + z * 64);
//    }
//
//    /**
...
//            final long[] target,
//            final SBS2 o,
//            final int arrayIndexBegin,
//            final int arrayIndexEnd,
//            final int startPosition,
//            final int endPosition) {
//
//        if (o == null) {
//            apply(target, arrayIndexBegin, arrayIndexEnd);
...
//        }
//
//        return o.applyOn(target, arrayIndexBegin, arrayIndexEnd, startPosition, endPosition);
//    }
//
...
//                    final int newLength = sparseApply(
//                            lengthSignIndicatesSet(_length),
//                            o,
//                            inLocalRangeStartPosition,
//                            inLocalRangeStartPosition + _absLength);
//
//                    if (newLength != _length) {
//                        ranges[x] = toSparseRaw(inLocalRangeStartPosition, newLength);
//                    }
//
//                    b += _absLength;
//                }
...
//                assert (isDense(raw));
//                final int _denseDataIndex = toDenseDataIndex(raw);
//                final HMNode targetNode = map.getNode(_denseDataIndex);
//                final int localStartPositionInclusive = b;
//                final int localEndPositionExclusive =
//                        Math.min(endPositionExclusive, targetNode.getEndPosition());
//
//                //final long oRaw = o.getByPosition(inLocalRangeStartPosition);
//                denseApply(targetNode, o, localStartPositionInclusive, localEndPositionExclusive);
//
